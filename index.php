...
<html lang="en">
   ...
   <body class="g-sidenav-show  bg-gray-100 virtual-reality">
               ...
               <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                  ...
                  <ul class="navbar-nav  justify-content-end">
                     <li class="nav-item d-flex align-items-center">
                        <a href="http://localhost/test/users/login.php" class="nav-link text-body font-weight-bold px-0">
      ...
      <div class="border-radius-xl mt-3 mx-3 position-relative" style="background-image: url('assets/img/background.png') ; background-size: cover;">
                        ...
                        <div class="row mt-4">
                           ...
                           <div class="col-lg-8 ">
                              <div class="card bg-gradient-dark move-on-hover">
                                 <div class="card-body">
                                    <div class="d-flex">
                                       <h5 class="mb-0 text-white">To Verify if the device has been flagged as stolen please enter the serial number in the text box below.
                                             </h5>
